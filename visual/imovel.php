...
<body>
    ...
    <main>
        <article> 
            <h1>Imóvel o que é?</h1>
                <h4>Imóveis são aqueles bens que não podem ser transportados sem perda ou deterioração.<br>
                Exemplo: Casa, Terreno, Apartamento e por ai vai...</h4>
                <br><br>
            <img src="imagens/casa.png">
...
<html>
    ...
    <body>
        ...
        <div class="menu_imovel bloco_de_conteudo"> 
        <h1>Testando imóvel</h1>
        <h2>Testando imóvel</h2>
        <h3>Testando imóvel</h3>
            <p>
