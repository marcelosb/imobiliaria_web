...
<body>
    ...
    <main>
        <article> 
            <h1>Conceito de Venda</h1>
                <h4>venda é a ação e o efeito de vender,<br>
                transferir a propriedade de algo para outra pessoa mediante <br>
                o pagamento de um preço estipulado.</h4><br>
                <img src="imagens/venda.jpg">    
        </article>
    </main>
...
<html>
    ...
    <body>
        ...
        <div class="menu_vender_imovel bloco_de_conteudo"> 
        <h1>Vender imóvel</h1>
        <h2><strong>Vender imóvel</strong></h2>
        <h3>Vender imóvel</h3>
            <p>
