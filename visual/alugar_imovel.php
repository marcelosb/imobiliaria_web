...
<body>
    ...
    <main>
        <article> 
            <h1>Conceito de Alugar - Imóvel</h1>
            
                Uma locação ou aluguel é um negócio jurídico onde uma das partes cede à outra o usufruto<br>
                de um bem de sua propriedade em troca de um pagamento.<br>
                <br>
                O locador é aquele que cede o bem mediante pagamento do locatário (ou inquilino) para que este<br>
                o utilize conforme as finalidades do bem - isto é: <br>
                Moradia, se for um imóvel residencial; <br>
                Trabalho, se for um imóvel comercial ou industrial;<br>
            
                <img src="imagens/alugar.jpg">
        </article>
    </main>
...
<html>
    ...
    <head>
        ...
        <link  href="estilo/bootstrap.min.css" rel="stylesheet" />
        <script type="text/javascript" src="script/bootstrap.min.js"></script>
        <script type="text/javascript" src="script/mostra_submenu.js"></script>
        <title> Alugar Imóvel</title>
    </head>
    ...
    <body>
        ...
        <div class="menu">
            <ul>
                ...
                <li><a onclick="mostraSubMenu('submenu');" href="#">Cliente</a>
                    
                    <div id="submenu" style="display: none; ">
                        <ul >
                            <li><a o href="cliente_pf.php" >PF</a></li>
                            <li><a href="cliente_pj.php">PJ</a></li>   
                        </ul>
                    </div>
                
                </li>
                <li><a href="imovel.php" >Imóvel</a></li>
                <li><a href="vender_imovel.php" >Vender</a></li>
                <li><a href="alugar_imovel.php" >Alugar</a></li>
            </ul>
        </div>  
        
        <div class="menu_alugar_imovel bloco_de_conteudo"> 
        <h1>Alugar imóvel</h1><br>
        <h3>Alugar imóvel</h3>
            <p>
                Se popularizou na década de 60, quando a Letraset lançou decalques <br>
                contendo passagens de Lorem Ipsum, e mais recentemente quando passou <br>
                a ser integrado a softwares de editoração eletrônica como Aldus PageMaker.<br>   
            </p>
        </div>
