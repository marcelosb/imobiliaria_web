        ...
        <article id="resposta"> 
            ...
            <?php 
                if(isset($_POST['cadastrar'])){
                    ...
                    if($clientePessoaFisicaControl->cadastrar() == true){
                        ...
                        echo '<div class="alert alert-info alert-dismissible"  role="alert">
                            ...
                            O <strong>CPF</strong> já está sendo utilizado por outra pessoa física!
                        </div>';
                    }
                ...
                if(isset($_POST['editar_cliente_pf'])){
                    $clientePessoaFisicaControl = new ClientePessoaFisicaControl();
                    $clientePessoaFisicaControl->atualizar();
                    echo '<div class="alert alert-info alert-dismissible"  role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                ...
                if(isset($_POST['deletar_cliente_pf'])){
                    $clientePessoaFisicaControl = new ClientePessoaFisicaControl();
                    $clientePessoaFisicaControl->excluir();  
                    ...
                    <div class="modal fade" id="myModal" role="dialog">
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          ...
                          <div style="background: #46b8da; color: white;" class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 style="text-align: center ; " class="modal-title">Formulário - Cadastrar Cliente Pessoa Física</h4>
                          </div>
                          ...
                          <div class="modal-body">
                              ...
                              <form method="POST" >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input style="text-transform: uppercase" type="text" class="form-control" id="" placeholder="Nome" name="campo_nome" required="required" x-moz-errormessage="Campo nome é de preenchimento obrigatório.">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input style="text-transform: uppercase;" type="text" class="form-control" id="inputEmail3" placeholder="Endereço" name="campo_endereco" required x-moz-errormessage="Campo de preenchimento obrigatório.">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input maxlength="14" data-masked-input="999.999.999-99" type="text" class="form-control" id="inputEmail3" placeholder="USE SOMENTE NÚMEROS" name="campo_cpf" required x-moz-errormessage="Por favor, preencha o campo de CPF.">
                                        </div>
                                    </div>
                                    <br><br>
                                    ...
                                    <button name="cadastrar" style="float: right" type="submit" class="btn btn-info btn-lg" value="cadastrar_cliente_pf" >Cadastrar</button>
                                    <br><br><br><br>
            ...
            <table  number-per-page="5" current-page="0" id="tabela" class="pagina table table-hover table-bordered" width="100%" cellspacing="0" >
                ...
                <tbody >
                    ...
                    <?php 
                        ...
                        $clientePessoaFisicaControl = new ClientePessoaFisicaControl();
                        $listarClientesPF = $clientePessoaFisicaControl->listar();
                                  ...
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      <div style="background: #2e6da4; color: white" class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        <h4 style="text-align: center" class="modal-title" id="exampleModalLabel">Formulário - Editar Cliente Pessoa Física</h4>
                                ...
                                <div class="modal-body">
                                    ...
                                    <form method="POST" >
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="hidden" class="form-control" value="<?php echo $codigo;?>" name="campo_editar_codigo" id="campo_editar_codigo">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label">Nome</label>
                                            <div class="col-sm-10">
                                                <input autofocus style="text-transform: uppercase" type="text" class="form-control" value="<?php echo $nome;?>" placeholder="Nome" name="campo_editar_nome" id="campo_editar_nome" required="required" x-moz-errormessage="Campo nome é de preenchimento obrigatório." >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label">Endereço</label>
                                            <div class="col-sm-10">
                                                <input style="text-transform: uppercase;" type="text" class="form-control" value="<?php echo $endereco;?>" placeholder="Endereço" name="campo_editar_endereco" required x-moz-errormessage="Campo de preenchimento obrigatório.">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label">CPF</label>
                                            <div class="col-sm-10">
                                                <input maxlength="14" data-masked-input="999.999.999-99" type="text" class="form-control" value="<?php echo $cpf;?>" placeholder="CPF" name="campo_editar_cpf" required x-moz-errormessage="Por favor, preencha o campo de CPF.">
                                            </div>
                                        </div>
                                        <br>
                                   ...
                                   <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-lg" name="editar_cliente_pf">Editar</button>
...
<div class="modal fade" id="excluir<?php echo $codigo;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 style="text-align: center"  class="modal-title" id="exampleModalLongTitle">Formulário - Excluir Cliente Pessoa Física</h4>
      </div>
      <div class="modal-body" style="text-align: center">
          <form method="POST" >
            <input type="hidden" name="delete_pelo_codigo" value="<?php echo $codigo; ?>">
            <h4>Deseja realmente <strong>excluir</strong> <?php echo $nome; ?>?</h4>
      </div>
      <div class="modal-footer">
          <button type="submit" class="btn btn-danger btn-lg" name="deletar_cliente_pf">Excluir</button>
        <button type="button" class="btn btn-secondary btn-lg" data-dismiss="modal">Cancelar</button>
      </div>
